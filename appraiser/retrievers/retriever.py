...
class Retriever(abc.ABC):
    ...
    def __init__(self, label: str,
        ...
        self.vector_save_filename = f'vectors_calculated_by_{feature_extractor.__name__}'
        self.vectors_full_path = os.path.join(self.label_save_dir, self.vector_save_filename)
